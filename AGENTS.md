...
- **Acronyms get `<abbr title="...">` on first use in a section**, with the term spelled out in the `title`. Seventy-two are marked up across six pages: `guides.html` (23), `tech_takes.html` (22), `privacy.html` (9), `index.html` (8), `tech_resources.html` (8), `hobbies.html` (2). Nothing in the SCSS styles `abbr`; the browser default is intentional. Match the pattern when you introduce a new acronym.
